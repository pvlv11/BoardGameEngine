...
class t_user_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = t_user
        # case specific czyli doslownie to co w modelu
...
class GamesReview(serializers.Serializer):
    ...
    review_number = serializers.DecimalField(
    ...
    def update(self, instance, validated_data):
        ...
        instance.user_id_id = validated_data.get(
            'user_id_id', instance.user_id_id)
        instance.game_id_id = validated_data.get(
            'game_id_id', instance.game_id_id)
        instance.review_number = validated_data.get(
...
class titles_serializer(serializers.Serializer):
    titles = serializers.CharField(required=True, max_length=10000)
